		...
		if obf_arg then
			...
			if (game.placeId == 4924922222) then
				...
				local Window = OrionLib:MakeWindow({
					["Name"] = "Sander X | Brookhaven RP | Executor: "   .. exploitName ,
					["HidePremium"] = false,
					["SaveConfig"] = false,
					["IntroText"] = "| Sander X |",
					["IntroIcon"] = "rbxassetid://7743870134",
				...
				Tab:AddParagraph("🐇Sander X V4.95 🐇Happy Easter🥚", "I'm SanderDev, the owner of the script. Thank you for using it");
				Tab:AddParagraph("🐇Sander X UPDATE", " V4.95 Vip🥚");
				...
				Tab:AddButton({
					["Name"] = "Roblox Group Click To Copy",
					["Callback"] = function()
						setclipboard("https://www.roblox.com/pl/communities/35289663/Sander-X-Team#!/about");
					end
				});
				Tab:AddButton({
					["Name"] = "Youtube Click To Copy",
					["Callback"] = function()
						setclipboard("https://www.youtube.com/@sanderxdev");
					end
				});
				Tab = Window:MakeTab({
					["Name"] = "Event Update",
