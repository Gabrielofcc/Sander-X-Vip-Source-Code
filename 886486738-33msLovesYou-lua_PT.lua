local Libary = loadstring(game:HttpGet("https://raw.githuÔnibusercontent.com/tbao143/
Library-ui/refs/heads/main/Redzhubui"))()
workspace.FallenPartsDestroyHeight = -math.huge

local Window = Libary:MakeWindow({
     Title = "Astazinho HUB BETA | Brookhaven RP ",
     SubTitle = "by: Yt:AstazinhoBOT",
     LoadText = "Carregando Script",
     Flags = "AstazinhoHUB_Broookhaven"
})
...
InfoTab:AddParagraph({ "Owner / Developer:", "Asta." })
InfoTab:AddParagraph({ "Colaborações:", "Ninguém kkkk,
Toddy" })
InfoTab:AddParagraph({ "Você está usando:", "Astazinho HUB " })
...
local library =
loadstring(game:HttpGet("https://raw.githuÔnibusercontent.com/miroeramaa/TurtleLib/
...
local function toggleBlackHole()
      blackHoleActive = not blackHoleActive
      if blackHoleActive then
            Button.Text = "Puxar Partes | Ligado"
...
Workspace.DescendantAdded:Connect(function(v)
            ...
            Button.Text = "Puxar Partes | Desligado"
...
-- Tab 4: Anti Sentar
TrollTab:AddSection({ "Anti Sentar" })
TrollTab:AddToggle({
    Name = "Anti Sentar",
...
-- Função para limpar o sofá (Sofá)
local function cleanupSofá()
    local char = LocalPlayer.Character
    if char then
        local Sofá = char:FindFirstChild("Chaos.Sofá") or
LocalPlayer.Backpack:FindFirstChild("Chaos.Sofá")
        if Sofá then
            Sofá:Destroy()
        end
    end
...
-- Função KillPlayerSofá
local function KillPlayerSofá()
...
"Sofá")
    ...
    local tool = LocalPlayer.Backpack:FindFirstChild("Sofá")
...
CFrame.Angles(math.rad(angle), 0, 0)
          ...
          local tool = char:FindFirstChild("Sofá")
...
-- Função BringWithSofá
local function BringWithSofá()
...
targetPlayer.Character:FindFirstChild("HumanoidRootPart") then
    ...
    local args = { [1] = "LimparTodasAsFerramentas" }
    ReplicatedStorage.RE["1Clea1rTool1s"]:FireServer(unpack(args))
    local args = { [1] = "PickingTools", [2] = "Sofá" }
    ReplicatedStorage.RE:FindFirstChild("1Too1l"):InvokeServer(unpack(args))
    local Sofá = LocalPlayer.Backpack:WaitForChild("Sofá", 2)
    if not Sofá then
        warn("Erro: Sofá não encontrado no Backpack")
        return
    end

    Sofá.Name = "Chaos.Sofá"
    local seat1 = Sofá:FindFirstChild("Seat1")
    local seat2 = Sofá:FindFirstChild("Seat2")
    local handle = Sofá:FindFirstChild("Handle")
    ...
    Sofá.Parent = LocalPlayer.Character
...
CFrame.new(-2, 2, 0)
        ...
        tet:Destroy()
        Sofá.Parent = LocalPlayer.Backpack
        task.wait()
        Sofá:FindFirstChild("Handle ").Name = "Handle"
        task.wait(0.2)
        Sofá.Parent = LocalPlayer.Character
        task.wait()
        Sofá.Parent = LocalPlayer.Backpack
        Sofá.Handle.Name = "Handle "
        task.wait(0.2)
        Sofá.Parent = LocalPlayer.Character
...
      tet:Destroy()
      ...
      Sofá.Parent = LocalPlayer.Character
      task.wait(0.3)
      Sofá.Grip = CFrame.new(Vector3.new(0, 0, 0))
      task.wait(0.3)
      ReplicatedStorage.RE["1Clea1rTool1s"]:FireServer("LimparTodasAsFerramentas")
end

-- Função KillWithSofá
local function KillWithSofá()
    local targetPlayer = Players:FindFirstChild(getgenv().Target)
    if not targetPlayer then
        warn("Erro: Nenhum jogador alvo selecionado")
        return
...
Players:FindFirstChild(selectedPlayerName) then
            ...
            if methodKill == "Sofá" then
                 KillPlayerSofá()
            elseif methodKill == "Sofá Sem ir até o alvo [BETA]" then
                 KillWithSofá()
            else
                 -- Método de ôniÔnibus
                 local character = LocalPlayer.Character
...
character:FindFirstChild("HumanoidRootPart")
                ...
                if not Ônibus then
                    ...
                    if remoteEvent and remoteEvent:FindFirstChild("1Ca1r") then
                        remoteEvent["1Ca1r"]:FireServer("PickingCar", "SchoolÔnibus")
                    end
                    task.wait(1)
                    Ônibus = GetÔnibus()
                end
                ...
                if Ônibus then
                    local seat = Ônibus:FindFirstChild("Body") and
Ônibus.Body:FindFirstChild("VehicleSeat")
...
2, 0)
                            task.wait()
                        until character.Humanoid.Sit or not Ônibus.Parent
                        if character.Humanoid.Sit or not Ônibus.Parent then
                            for k, v in pairs(Ônibus.Body:GetChildren()) do
                                if v:IsA("Seat") then
                                    v.CanTouch = false
                                end
                            end
...
Ônibus:SetPrimaryPartCFrame(CFrame.new(Vector3.new(9999, -450, 9999)))
                                        print("Jogador sentou, levando ôniÔnibus para
o void!")
                                        task.wait(0.2)
...
targetPlayer.Character.HumanoidRootPart
                                    ...
                                    Ônibus:SetPrimaryPartCFrame(targetRoot.CFrame *
...
targetPlayer.Character:FindFirstChildOfClass("Humanoid")
                                if targetHumanoid and targetHumanoid.Sit then
                                    if character.Humanoid then
                                        Ônibus:SetPrimaryPartCFrame(originalPosition)
                                        task.wait(0.7)
...
    if not isItemInInventory("Sofá") then
        local args = { [1] = "PickingTools", [2] = "Sofá" }
...
local NOME_FERRAMENTA = "Click Fling Sofá"
...
rep:WaitForChild("RE"):WaitForChild("1Clea1rTool1s"):FireServer("LimparTodasAsFerramentas")
      task.wait(0.2)

        rep.RE:FindFirstChild("1Too1l"):InvokeServer("PickingTools", "Sofá")
        task.wait(0.3)

        local sofa = eu.Backpack:FindFirstChild("Sofá")
        if sofa then
              sofa.Parent = boneco
        end
        task.wait(0.1)
...
local NOME_FERRAMENTA = "Click Lançar Bola"
local ferramentaEquipada = false
...
local   NOME_FERRAMENTA = "Click Kill Sofá"
local   ferramentaEquipada = false
local   nomeAlvo = nil
local   loopTP = nil
...
function limparSofa()
      ...
      if sofaEquipado then
            local boneco = eu.Character
            if boneco then
                  local sofa = boneco:FindFirstChild("Sofá")
                  if sofa then
...
       local mochila = eu.Backpack
       ...
       if not mochila:FindFirstChild("Sofá") and not boneco:FindFirstChild("Sofá")
then
             local args = { "PickingTools", "Sofá" }
             rep.RE["1Too1l"]:InvokeServer(unpack(args))
             task.wait(0.1)
       end

      local sofa = mochila:FindFirstChild("Sofá") or
boneco:FindFirstChild("Sofá")
      if sofa then
            sofa.Parent = boneco
            sofaEquipado = true
      end
...
targetPlayer.Character:FindFirstChildOfClass("Humanoid")
                if targetHumanoid and targetHumanoid.Sit then
                    local Ônibus = GetÔnibus()
                    if Ônibus then
                        Ônibus:SetPrimaryPartCFrame(CFrame.new(destination))
                        print("Jogador sentou, levando ôniÔnibus para o void!")
...
frente/trás
                          ...
                          local Ônibus = GetÔnibus()
                          if Ônibus then
                              Ônibus:SetPrimaryPartCFrame(targetRoot.CFrame * CFrame.new(0,
0, frontBackOffset))
                          end
                    end
                end
...
local function StartKillÔnibusao(playerName, callback)
...
local function PerformActionForAllPlayers(players)
    if #players == 0 then
      ...
      StartKillÔnibusao(player.Name, function()
           task.wait(0.5)
...
print("Kill All Ônibus button created")

Troll:AddButton({
    Name = "Banir Jogador da Casa All",
    Callback = function()
        local ReplicatedStorage = game:GetService("ReplicatedStorage")
local Players = game:GetService("Players")
local Workspace = game:GetService("Workspace")
...
print("Banir Jogador da Casa All button created")
...
ReplicatedStorage.RE:FindFirstChild("1Too1l"):InvokeServer("PickingTools", "Sofá")
        end)
...
for m=1,ewoifjwoifjiwo do
    game.Players.LocalPlayer.Backpack.Sofá.Name = "Sofá"..m
end
wait()
for weofefawd,iwiejguiwg in pairs(game.Players.LocalPlayer.Backpack:GetChildren())
do
    if iwiejguiwg.Name == "Sofá"..weofefawd then
...
game.Players.LocalPlayer.Backpack["Sofá"..skjdfuwiruwg]:FindFirstChild("Seat1").Di
sabled = true

game.Players.LocalPlayer.Backpack["Sofá"..skjdfuwiruwg]:FindFirstChild("Seat2").Di
sabled = true
        game.Players.LocalPlayer.Backpack["Sofá"..skjdfuwiruwg].Parent =
game.Players.LocalPlayer.Character
        tet = Instance.new("BodyVelocity",
game.Players.LocalPlayer.Character["Sofá"..skjdfuwiruwg]:FindFirstChild("Handle
"))
        tet.MaxForce = Vector3.new(math.huge,math.huge,math.huge)
        tet.P = 1250
        tet.Velocity = Vector3.new(0,0,0)
...
game.Players.LocalPlayer.Character["Sofá"..skjdfuwiruwg]:FindFirstChild("Seat1").C
Frame = CFrame.new(Vector3.new(pos.x,pos.y,pos.z)) * CFrame.new(-2,2,0)
                task.wait()
            end
            game.Players.LocalPlayer.Character["Sofá"..skjdfuwiruwg].Parent =
game.Players.LocalPlayer.Backpack
            wait()

game.Players.LocalPlayer.Backpack["Sofá"..skjdfuwiruwg]:FindFirstChild("Handle
").Name = "Handle"
            wait(0.2)
            game.Players.LocalPlayer.Backpack["Sofá"..skjdfuwiruwg].Parent =
game.Players.LocalPlayer.Character
            ...
            game.Players.LocalPlayer.Character["Sofá"..skjdfuwiruwg].Parent =
game.Players.LocalPlayer.Backpack
            game.Players.LocalPlayer.Backpack["Sofá"..skjdfuwiruwg].Handle.Name =
"Handle "
            wait(0.2)
            game.Players.LocalPlayer.Backpack["Sofá"..skjdfuwiruwg].Parent =
game.Players.LocalPlayer.Character
            tet = Instance.new("BodyVelocity",
game.Players.LocalPlayer.Character["Sofá"..skjdfuwiruwg]:FindFirstChild("Seat1"))
            tet.MaxForce = Vector3.new(math.huge,math.huge,math.huge)
            tet.P = 1250
            tet.Velocity = Vector3.new(0,0,0)
            tet.Name = "#mOVOOEPF$#@F$#GERE..>V<<<<EW<V<<W"
...
print("Bring All Sofá button created")

Troll:AddButton({
    Name = "Kill All Sofá [melhor]",
    Callback = function()
        local args = {
    [1] = "LimparTodasAsFerramentas"
}
...
for m=1,ewoifjwoifjiwo do
    game.Players.LocalPlayer.Backpack.Sofá.Name = "Chaos Sofá"..m
end
wait()
for weofefawd,iwiejguiwg in pairs(game.Players.LocalPlayer.Backpack:GetChildren())
do
    if iwiejguiwg.Name == "Chaos Sofá"..weofefawd then
        iwiejguiwg.Handle.Name = "Handle "
    end
end
wait(0.2)
...
Sofá"..skjdfuwiruwg]:FindFirstChild("Seat1").Disabled = true
        game.Players.LocalPlayer.Backpack["Chaos
Sofá"..skjdfuwiruwg]:FindFirstChild("Seat2").Disabled = true
        game.Players.LocalPlayer.Backpack["Chaos Sofá"..skjdfuwiruwg].Parent =
game.Players.LocalPlayer.Character
        tet = Instance.new("BodyVelocity",
game.Players.LocalPlayer.Character["Chaos
Sofá"..skjdfuwiruwg]:FindFirstChild("Handle "))
        tet.MaxForce = Vector3.new(math.huge,math.huge,math.huge)
        tet.P = 1250
        tet.Velocity = Vector3.new(0,0,0)
        tet.Name = "#mOVOOEPF$#@F$#GERE..>V<<<<EW<V<<W"
        repeat
            for m=1,35 do
                ...
                pos.z = pos.z + woiejewg.Character.HumanoidRootPart.Velocity.Z / 2
                game.Players.LocalPlayer.Character["Chaos
Sofá"..skjdfuwiruwg]:FindFirstChild("Seat1").CFrame =
CFrame.new(Vector3.new(pos.x,pos.y,pos.z)) * CFrame.new(-2,2,0)
                task.wait()
            end
            game.Players.LocalPlayer.Character["Chaos Sofá"..skjdfuwiruwg].Parent
= game.Players.LocalPlayer.Backpack
            wait()
            game.Players.LocalPlayer.Backpack["Chaos
Sofá"..skjdfuwiruwg]:FindFirstChild("Handle ").Name = "Handle"
            wait(0.2)
            game.Players.LocalPlayer.Backpack["Chaos Sofá"..skjdfuwiruwg].Parent =
game.Players.LocalPlayer.Character
            wait()
...
= game.Players.LocalPlayer.Backpack
            game.Players.LocalPlayer.Backpack["Chaos
Sofá"..skjdfuwiruwg].Handle.Name = "Handle "
            wait(0.2)
            game.Players.LocalPlayer.Backpack["Chaos Sofá"..skjdfuwiruwg].Parent =
game.Players.LocalPlayer.Character
            tet = Instance.new("BodyVelocity",
game.Players.LocalPlayer.Character["Chaos
Sofá"..skjdfuwiruwg]:FindFirstChild("Seat1"))
            tet.MaxForce = Vector3.new(math.huge,math.huge,math.huge)
            tet.P = 1250
            tet.Velocity = Vector3.new(0,0,0)
            tet.Name = "#mOVOOEPF$#@F$#GERE..>V<<<<EW<V<<W"
...
print("Kill All Sofá button created")

Troll:AddButton({
    Name = "Lançar Bola all",
    Callback = function()
...
local carList = {
    "SchoolÔnibus", "SmartCar", "FarmTruck", "Cadillac", "Excavator",
...
-- Botão para Sofá Aura
ToolsTab:AddButton({
    Name = "Sofá Aura",
    Callback = function()
    nametools = "Sofá Spray lel"
                oldcframe =
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame
game:GetService("StarterGui"):SetCore("SendNotification",{Title="Dupe
Script",Text="Please do not equip any tools or unequip tools or click tools on
inventory. It will break the script.", Button1 = "I understand" ,Duration=5})
                toolthatiwanttodupe = "Sofá"
                tools = "Sofá"
                if game.Players.LocalPlayer.Character.Humanoid.Sit == true then
                        task.wait()
                        game.Players.LocalPlayer.Character.Humanoid.Sit = false
...
UniversalTab:AddButton({
    ...
    Callback = function()
        loadstring(game:HttpGet("https://raw.githuÔnibusercontent.com/EdgeIY/
...
UniversalTab:AddButton({
    Name = "TP Tool",
    Callback = function()
        loadstring(game:HttpGet("https://raw.githuÔnibusercontent.com/err0r129/
...
loadstring(game:HttpGet("https://raw.githuÔnibusercontent.com/FilteringEnabled/
...
UniversalTab:AddButton({
    Name = "Telekinesis",
    Callback = function()
        loadstring(game:HttpGet("https://raw.githuÔnibusercontent.com/SAZXHUB/Control-
